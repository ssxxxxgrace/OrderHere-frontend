...
export const EditRestaurantModal = ({ restaurantId, initialData, onClose, onUpdate }) => {
    ...
    const renderTimeFields = () => {
        const selectedDayData = formData.openingHours.find(hour => hour.dayOfWeek === selectedDay);
                        ...
                        <FormControl fullWidth margin="normal">
                            ...
                            >
                                {formData.openingHours.map((hour, index) => (
                                    <MenuItem key={index} value={hour.dayOfWeek}>{hour.dayOfWeek.charAt(0).toUpperCase() + hour.dayOfWeek.slice(1)}</MenuItem>
                                ))}
                            </Select>
                        </FormControl>
